...
export function UpdateBalance() {
  ...
  if (depMoney > 100 && depMoney < 1000000) {
    ...
    alert(
      'Cannot Deposit. Minimum deposit is 100 and Maximum deposit is 1000000.'
    );
  }
...
export function UpdateWithdraw() {
  ...
  if (balance <= 1000 || updated < 1000) {
    alert(
      'Cannot withdraw because minimum balance should be 1000. Minimum withdraw is 100 and Maximum withdraw is 1000000.'
    );
